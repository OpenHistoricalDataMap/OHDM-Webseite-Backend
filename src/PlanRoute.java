...
public class PlanRoute extends HttpServlet {
	...
	/**
	 * Servlet which is called by route.js gets data from the Website and writes a POST Request to a private port. Response is given funneled trough route.js which visualizes the outcome.
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			InputStream iS = stringEntity.getContent();
